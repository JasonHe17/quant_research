...
class DataPortal:
    ...
    def get_trading_calendar(
        ...
        return self._adapter.get_trading_calendar(market=market, start=start, end=end)
    ...
    def get_fundamentals_asof(
        ...
        *,
        ...
        frame = self._adapter.get_fundamentals_asof(
            symbols,
            dataset=dataset,
            as_of=as_of,
            market=market,
    ...
    def get_market_indicators(
        ...
        *,
        ...
        frame = self._adapter.get_market_indicators(
            names=names,
            start=start,
            end=end,
            frequency=frequency,
